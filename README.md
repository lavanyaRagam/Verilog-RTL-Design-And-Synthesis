# Verilog RTL Design and Synthesis Workshop
...
This program is designed for students and engineers who want to gain knowledge in:
...
- Understanding essential digital design concepts, such as testbenches, timing libraries, D flip-flop coding styles, and optimization techniques  
...
- [Day 2: Standard Cell Library, Logic Synthesis and Flip-Flop Design](./Day-2)  
- [Day 3: Combinational and Sequential Logic Optimization](./Day-3)  
- [Day 4: Gate-Level Simulation (GLS), Blocking vs. Non-Blocking in Verilog, and Synthesis-Simulation Mismatch](./Day-4)  
- [Day 5: Optimization in Synthesis](./Day-5)  
